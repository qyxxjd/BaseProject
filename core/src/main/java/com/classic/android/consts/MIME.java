package com.classic.android.consts;

/**
 * 应用名称: BaseProject
 * 包 名 称: com.classic.android.consts
 *
 * 文件描述: 常用的MIME扩展类型对应的ContentType
 * 创 建 人: 续写经典
 * 创建时间: 2015/11/4 18:34
 */
@SuppressWarnings({"unused", "SpellCheckingInspection"}) public final class MIME {
