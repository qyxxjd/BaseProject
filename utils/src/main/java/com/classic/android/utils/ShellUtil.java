 ...
 */
@SuppressWarnings({"unused", "WeakerAccess"}) public final class ShellUtil {
    ...
    public static CommandResult execCommand(String[] commands, boolean isRoot,
        ...
        try {
            ...
            for (String command : commands) {
                ...
                os.write(command.getBytes(CHARSET_NAME));
            ...
            if (isNeedResultMsg) {
                ...
                successResult = new BufferedReader(
                        new InputStreamReader(process.getInputStream(), CHARSET_NAME));
     ...
     * @author <a href="http://www.trinea.cn" target="_blank">Trinea</a> 2013-5-16
     */
    @SuppressWarnings("WeakerAccess") public static class CommandResult {
